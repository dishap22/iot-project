...
# Start timestamp
start_timestamp = datetime.strptime("2024-04-01T00:00:00+00:00", "%Y-%m-%dT%H:%M:%S%z").replace(tzinfo=timezone.utc)
...
with open('data2.csv', 'w', newline='') as csvfile:
    ...
    while current_timestamp < start_timestamp + timedelta(days=13):
